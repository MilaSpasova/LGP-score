...
# python FKandMTLD.py --results-path "data/advResults" --texts-dir "data/OneStopEnglishCorpus/Texts-SeparatedByReadingLevel/Adv-Txt"
import argparse
import csv
import re
...
def count_syllables(word: str) -> int:
    ...
    if w.endswith("e") and not w.endswith(("le", "ye")) and count > 1:
        count -= 1
    if w.endswith("es") and len(w) > 2 and count > 1:
        count -= 1
